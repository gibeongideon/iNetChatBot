  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Container(
        decoration: BoxDecoration(color: const Color(0xFFCCCCFF), boxShadow: [
          BoxShadow(
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              decoration:
                  BoxDecoration(color: const Color(0xFFCCCCFF), boxShadow: [
                BoxShadow(
                    color: Colors.grey.shade500,
                    offset: const Offset(4, 4),
                    blurRadius: 15,
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  GestureDetector(
                    onTap: () {
                      modelsProvider.webContact(
                          "https://www.facebook.com/gideon.gibeon/");
                    },
                    child: Container(
                  ...
                  GestureDetector(
                    onTap: () {
                      modelsProvider.webContact("https://www.instagram.com/");
                    },
                    child: Container(
                      padding: const EdgeInsets.all(4),
                      decoration: BoxDecoration(
                  ...
                  GestureDetector(
                    onTap: () {
                      modelsProvider
                          .webContact("https://github.com/gibeongideon/");
                    },
                    child: Container(
                      padding: const EdgeInsets.all(4),
                      decoration: BoxDecoration(
